			...
			<div class="card">
				...
				<div class="card-body">
					...
					<form method="post" class="form-horizontal" id="processsell" action="index.php?view=processsell">
						...
						<div class="form-group">
							<label for="inputEmail1" class="col-lg-2 control-label">Dto. por revendedor: </label>
							<div class="col-lg-10">
						...
						<!-- campo para agregar una nota si esta venta está pendiente de pago por el cliente -->
						<div class="form-group">
							<label for="note">Nota de crédito:</label>
							<input type="text" name="note" class="form-control" placeholder="Ingrese una nota si es necesario">
						</div>
