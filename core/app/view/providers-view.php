	...
	<div class="card-header">
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				<a href="index.php?view=editprovider&id=<?php echo $user->id;?>" class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i></a>
				<a href="index.php?view=delprovider&id=<?php echo $user->id;?>" class="btn btn-sm btn-danger"><i class="bi bi-trash"></i></a
