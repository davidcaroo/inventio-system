...
// Verifica si hay productos con inventario bajo el mínimo.
					...
					<table class="table table-bordered table-hover">
						...
						<?php foreach ($products as $product): ?>
							...
							<?php if ($q <= $product->inventary_min): ?>
								<tr class="<?php echo ($q == 0 || $q <= $product->inventary_min / 2) ? 'danger' : 'warning'; ?>">
									...
									<td>
										...
										if ($q == 0) {
											...
											echo "<span class='label label-warning'>Quedan pocas existencias. Ya debes comprar!</span>";
										}
										?>
									</td>
								</tr>
